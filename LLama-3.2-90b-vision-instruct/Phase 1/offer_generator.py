"""
Offer Generator - Uses NVIDIA API to generate personalized, policy-compliant offers
"""
    ...
    def _call_nvidia_api(self, prompt: str) -> str:
        ...
        try:
            payload = {
                "model": self.model,
                "messages": [
                    {"role": "system", "content": "You are an expert offer designer for American Express. You create personalized, policy-compliant offers. Always respond with valid JSON only."},

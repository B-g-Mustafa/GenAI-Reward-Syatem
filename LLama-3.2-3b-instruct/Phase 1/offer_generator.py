"""
Offer Generator - Uses NVIDIA API via LangChain to generate personalized, policy-compliant offers
"""
...
class OfferGenerator:
    ...
    def __init__(self):
        ...
        # Initialize LangChain ChatNVIDIA client
        self.llm = ChatNVIDIA(
...
Generate the strategy-aligned offer now:"""
    ...
    def _call_nvidia_api(self, prompt: str) -> str:
        """Call NVIDIA API using LangChain ChatNVIDIA"""
        
        try:
            messages = [
                SystemMessage(content="You are an expert offer designer for American Express. You create personalized, policy-compliant offers. Always respond with valid JSON only."),

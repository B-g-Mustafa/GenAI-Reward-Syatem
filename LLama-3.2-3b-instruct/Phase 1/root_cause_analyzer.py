...
"causal_analysis": {{
    ...
    "justification": "Comprehensive 3-4 sentence explanation connecting observed behavior to archetype classification. Explain the causal reasoning: why the offer would/wouldn't change behavior, what evidence supports this, and what the counterfactual scenario suggests.",
    "key_signals": [
    "Signal 1 supporting classification",
    "Signal 2 supporting classification",
    "Signal 3 supporting classification"
    ],
    "counterfactual_scenario": "2-3 sentence description of what would likely happen if NO offer is sent, based on current trajectory and behavioral patterns"
}},
"insights": [
...
"reasoning": "2-3 sentence summary explaining the probable incremental impact of an offer on this specific user, grounded in causal inference principles"
}}

**CRITICAL GUIDELINES:**
- Focus on INCREMENTAL impact, not just likelihood to convert
- A user likely to buy anyway (Sure Thing) has LOW uplift despite high conversion probability
- A user on the fence (Persuadable) has HIGH uplift potential
- Use counterfactual reasoning: always compare "with offer" vs "without offer" scenarios
- Be specific about causal mechanisms, not just correlations
